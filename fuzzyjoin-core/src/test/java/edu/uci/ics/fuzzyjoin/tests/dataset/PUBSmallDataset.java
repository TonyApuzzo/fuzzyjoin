...
public class PUBSmallDataset extends AbstractDataset {
    private static final int NO_RECORDS = 160;
    private static final String NAME = "pub-small";
    ...
    public PUBSmallDataset(String base) {
        setBase(base);
    }
