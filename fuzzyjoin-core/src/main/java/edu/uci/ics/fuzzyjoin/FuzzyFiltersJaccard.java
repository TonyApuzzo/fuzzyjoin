...
public class FuzzyFiltersJaccard {
    ...
    public long getIntersectUpperBound(int noGramsCommon, long positionX,
            long positionY, long lengthX, long lengthY) {
        return noGramsCommon
                + Math.min(lengthX - positionX - 1, lengthY - positionY - 1);
    }
    ...
    public boolean passPositionFilter(int noGramsCommon, long positionX,
            long positionY, long lengthX, long lengthY) {
        return getIntersectUpperBound(noGramsCommon, positionX, positionY,
                lengthX, lengthY) >= getIntersectLowerBound(lengthX, lengthY);
    }
