...
public class RecordGroupFactory {
    public static RecordGroup getRecordGroup(String recordGroup, int noGroups,
            SimilarityFilters fuzzyFilters, String lengthstatsPath) {
        if (recordGroup.equals("LengthCount")) {
            return new RecordGroupLengthCount(noGroups, fuzzyFilters,
                    lengthstatsPath);
            ...
            return new RecordGroupLengthRange(noGroups, fuzzyFilters,
                    lengthstatsPath);
